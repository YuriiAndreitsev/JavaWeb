...
//    final static String SELECT_PRODUCT_BY_ID = "select * from products join productimage on productimage.product_id=products.id join images on images.id=productimage.image_id WHERE products.id=?";
    final static String SELECT_PRODUCT_BY_ID = "select * from prodcat join products on products.id=prodcat.product_id join category on category.id=prodcat.category_id join productimage on productimage.product_id=prodcat.product_id join images on productimage.image_id=images.id WHERE products.id=?";
