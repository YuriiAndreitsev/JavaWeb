    ...
    <table border='1'>
        ...
        <tr>
            ...
            <td>
                ...
                <input type='text' id='qnt${product.key.id}' size='2' value='1'/>
                <img src='./images/plus.png' onclick="plus(${product.key.id})" width='20' height='20'/>
                <input type='button' onclick="remove(${product.key.id})" value='remove'/>
            </td>
        </tr>
    </table>
    <hr>
